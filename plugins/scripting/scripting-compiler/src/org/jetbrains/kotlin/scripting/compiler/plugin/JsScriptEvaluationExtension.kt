...
fun loadJsScriptConfiguration(
    configuration: CompilerConfiguration,
    loadPlugins: (CompilerConfiguration) -> ExitCode = { _ -> ExitCode.OK }
) {
...
class JsScriptEvaluationExtension : AbstractScriptEvaluationExtension() {
    ...
    override fun setupScriptConfiguration(configuration: CompilerConfiguration, sourcePath: String) {
        loadJsScriptConfiguration(configuration)
    }

    override fun ScriptEvaluationConfiguration.Builder.platformSpecificConiguration() {}
